...
\begin{frame}{Aims}
  \begin{itemize}
    ...
    \item How spatial cues are \textbf{delivered}: channels, ears, or a sound field.
  \end{itemize}
\end{frame}
...
\begin{frame}{Roadmap}
  \begin{enumerate}
    ...
    \item Spatial audio — stereo phantom images and the sweet spot; binaural/HRTF; ambisonics.
  \end{enumerate}
\end{frame}
...
\begin{frame}{In-class}
  \begin{itemize}
    ...
    \item Walk out of the sweet spot on a centred vocal — hear the phantom image collapse.
  \end{itemize}
\end{frame}
